package com.wordpress.craftminemods.tconmaterial.potion_effect.effectclasses;
...
public class PotionColdFlames extends Potion {
		...
		public PotionColdFlames() {
			...
			setPotionName("coldflames");
			potionIcon = new ResourceLocation("deepcraft:textures/other/coldflames.png");
		}
