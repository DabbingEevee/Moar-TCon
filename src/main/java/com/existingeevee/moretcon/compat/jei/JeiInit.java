...
public class JeiInit {
	...
	public static void init(IModRegistry registry) {
		...
		if (CompatManager.loadMain) {
			...
			CUSTOM.add(new JeiInformationContainer<>(itemstack, new ItemStack(ModBlocks.oreEchostone, 1), "Found rare-ish-ly in all endstone-bearing dimensions from y = 12 <-> 48.", () -> CompatManager.loadMain));
