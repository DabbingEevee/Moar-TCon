...
public class InvertedTextureColoredTexture extends AbstractColoredTexture {
	...
	public static class Texture extends AbstractMaterialRenderInfo {
		...
		public TextureAtlasSprite getTexture(ResourceLocation baseTexture, String location) {
			...
			InvertedTextureColoredTexture sprite = new InvertedTextureColoredTexture(new ResourceLocation(blockTexture.getIconName()),
	...
	public InvertedTextureColoredTexture(ResourceLocation addTextureLocation, ResourceLocation baseTexture,
			String spriteName) {
	...
	protected int colorPixel(int pixel, int pxCoord) {
		...
		if (!stencil) {
			r = mult(r, 255-RenderUtil.red(pixel));
			g = mult(g, 255-RenderUtil.green(pixel));
			b = mult(b, 255-RenderUtil.blue(pixel));
		}
