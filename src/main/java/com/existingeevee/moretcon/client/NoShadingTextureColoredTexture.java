...
public class NoShadingTextureColoredTexture extends AbstractColoredTexture {
	...
	public static class Texture extends AbstractMaterialRenderInfo {
		...
		public TextureAtlasSprite getTexture(ResourceLocation baseTexture, String location) {
			...
			NoShadingTextureColoredTexture sprite = new NoShadingTextureColoredTexture(
	...
	public NoShadingTextureColoredTexture(ResourceLocation addTextureLocation, ResourceLocation baseTexture,
			String spriteName) {
