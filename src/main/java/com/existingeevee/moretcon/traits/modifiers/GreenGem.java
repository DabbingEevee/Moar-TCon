...
public class GreenGem extends ToolModifier {

	public GreenGem() {
		super(Misc.createNonConflictiveName("modgreengem"), 0x00FF00);
		this.addItem(ItemRegistry.GREEN_MIDDLE_GEM);
	...
	public void applyEffect(NBTTagCompound rootCompound, NBTTagCompound modifierTag) {
		...
		rootCompound.setInteger("Gem", CircleGemType.GREEN.id);
