...
public class BlueGem extends ToolModifier {

	public BlueGem() {
		super(Misc.createNonConflictiveName("modbluegem"), 0x0000FF);
		this.addItem(ItemRegistry.AQUA_MIDDLE_GEM);
	...
	public void applyEffect(NBTTagCompound rootCompound, NBTTagCompound modifierTag) {
		...
		rootCompound.setInteger("Gem", CircleGemType.AQUA.id);
